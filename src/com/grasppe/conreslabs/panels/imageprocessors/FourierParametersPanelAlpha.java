 ...
 */
public class FourierParametersPanelAlpha extends ModuleParametersPanel implements PropertyChangeListener {
   ...
   * Create the panel.
   */
  public FourierParametersPanelAlpha() {
  ...
  public static void main(String[] args) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        JFrame frame = new JFrame("FourierParametersPanelAlpha Demo");

        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        // Add contents to the window.
        frame.getContentPane().add(new FourierParametersPanelAlpha());
