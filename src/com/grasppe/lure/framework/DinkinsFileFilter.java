 ...
 * @author Jeff Dinkins
 */
public class DinkinsFileFilter extends FileFilter {
     ...
     * @param description
     */
    public DinkinsFileFilter(String extension, String description) {
        this();
     ...
     * @param description
     */
    public DinkinsFileFilter(String[] filters, String description) {
        this();
