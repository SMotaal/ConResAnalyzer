...
public class BlockState implements ISteppingBlockState, Cloneable {
  ...
  public enum PatchDesignation {
    VOID(BlockState.VOID), PASS(BlockState.PASS), MARGINAL(BlockState.MARGINAL), FAIL(BlockState.FAIL), CLEAR(BlockState.CLEAR),
  ...
  public int getValue(int row, int column) {
    ...
    GrasppeKit.debugText("BlockState",
                         "Get Value: " + row + ", " + column + " [" + blockMap[0].length + "x" + blockMap.length + "]", dbg);
