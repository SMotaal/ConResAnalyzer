...
public class CaseModel {
    ...
    public String toString() {
        ...
        try {
            ...
            int beginIndex = path.lastIndexOf(File.separator,path.lastIndexOf(File.separator,path.lastIndexOf(File.separator)-2)-2);
        ...
        returnString = GrasppeKit.cat(new String[] {
        		title, tdfString, imageString, loadedString, pathString
        });
