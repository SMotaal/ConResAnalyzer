...
public class CornerSelector extends AbstractController {
  ...
  public void update() {
    ...
    try {
      if ((activeBlock == null) || (imagePlus == null)) hideSelectorView();
    } catch (Exception exception) {}
...
//  if (blockImage!=modelImage && view!=null && view.getImageWindow()!=null) // && view.getImageWindow().isVisible())
//          showSelectorView();
    if (getBlockImage() != null) getModel().setTargetImageFile(getBlockImage());
    else getModel().setTargetImageFile(null);
