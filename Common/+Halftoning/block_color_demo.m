function block_color_demo(action,varargin);

% BLOCKERRDIFFDEMO Block Color Error Diffusion Halftoning Demo
%                  
%   This Demo lets you design digital color halftones by Block
...
%   The color halftones are generated by applying Block
...
% If block_color_demo is already running, bring it to the foreground.
...
callbackStr='block_color_demo(''SaveHalftone'');';
...
btnHt = 0.055; btnWid=0.23; txtsp = 0.043;
labelPos = [left-btnWid/3.1 0.12+yRef+btnHt*1.0 3*btnWid txtsp];
h = uicontrol('Parent', FirDemoFig, ...
   ...
   callBackStr = 'block_color_demo(''setUpMethod'');';
...
hdl.ImgPop=uicontrol('Parent', FirDemoFig, ...
   ...
   'Tag','ImagesPop',...
   'Callback','block_color_demo(''LoadNewImage'');');
...
callbackStr='block_color_demo(''setUpBlock'');';
...
callbackStr = 'block_color_demo(''textBlockRows'');';
...
callbackStr = 'block_color_demo(''textBlockColumns'');';
...
callbackStr = 'block_color_demo(''textBlockMask'');';
...
labelStr='Raster';
callbackStr='block_color_demo(''RadioUPDATE'',1);';
...
yPos = btnTop-(btnNumber-1)*(radioHt+spacing);
labelStr='Serpentine';
callbackStr='block_color_demo(''RadioUPDATE'',2);';
...
callbackStr='block_color_demo(''GenerateHalftone'');';
...
% The INFO button
labelStr='Info';
callbackStr='helpwin block_color_demo';
...
imwrite(block_halftone,'block_color_halftone.tif');
...
OUT(:,:,1) = bed(inp1,N,mask1,mask0,sp);
OUT(:,:,2) = bed(inp2,N,mask1,mask0,sp);
OUT(:,:,3) = bed(inp3,N,mask1,mask0,sp);
